...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.about-card, .project-card, .research-card, .contact-card, .stat-card');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    externalLinks.forEach(link => {
        link.addEventListener('click', () => {
            // Track external link clicks (you can add analytics here)
